    ...
    <PageShell
      ...
      sections={[
        ...
        },
        {
          ...
          eyebrow: 'Learning',
          title: 'Video & links',
          description: 'Curated playlists and external links worth your time.',
          featured: 0,
          items: [
            { icon: Video, title: 'Video playlists', description: 'Hand-picked YouTube playlists for every core subject, reviewed by seniors.' },
            { icon: Link2, title: 'Useful links', description: 'A categorized directory of student-useful websites, tools and references.' },
            { icon: Star, title: 'Recommended courses', description: 'Free and paid courses worth taking alongside your coursework.' },
